...
fn decl_to_ast(kind: &DeclKind) -> (Kind, &'static str) {
    match kind {
        ...
        DeclKind::Unfold => (Kind::Decl, "unfold"),
        DeclKind::Subset => (Kind::Decl, "subset"),
        DeclKind::Superset => (Kind::Decl, "superset"),
        DeclKind::Iso => (Kind::Decl, "iso"),
        DeclKind::NotIso => (Kind::Decl, "not-iso"),
