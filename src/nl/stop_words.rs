...
const STOP_WORDS: &[&str] = &[
    ...
    "down", "during", "except", "inside", "near", "off", "onto", "out",
    "outside", "over", "past", "since", "through", "throughout", "toward",
    "under", "until", "up", "upon", "within", "without",
    // Conjunctions
    "and", "but", "or", "nor", "yet", "so", "both", "either", "neither",
    "not", "only", "than", "whether", "while",
    // Auxiliary verbs
    "am", "are", "be", "been", "being", "can", "could", "did", "do",
    "does", "had", "has", "have", "is", "may", "might", "must", "shall",
    "should", "was", "were", "will", "would",
    // Pronouns
    "he", "her", "him", "his", "it", "its", "me", "my", "our", "she",
    "their", "them", "they", "us", "we", "you", "your",
    // Demonstratives / determiners
    "that", "these", "this", "those",
    // Other function words
    "all", "also", "any", "as", "each", "else", "even", "every",
    "here", "how", "if", "just", "more", "most", "much", "no",
    "now", "once", "other", "own", "same", "some", "still", "such",
    "then", "there", "too", "very", "what", "when", "where", "which",
    "who", "whom", "whose", "why",
];
