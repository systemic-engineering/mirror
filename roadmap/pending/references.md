...
- `docs/insights/2026-05-26-glass-wall-and-cross-wall-kintsugi.md` — substrate-pull as Ricci flow + namespace migration.
- `docs/insights/2026-05-26-heuristic-termination-for-sub-turing-subgraphs.md` — @epistemologic/heuristic.
- `docs/insights/2026-05-26-epistemologic-reality-constructivism-and-the-lens-that-makes-a-peer.md` — lens + identity + gestalt; constructivism made structural.
- `docs/insights/2026-05-26-spectral-garden-as-vetted-corpus-distribution.md` — @spectral/garden.
- `docs/insights/2026-05-26-fate-as-recursive-multi-trajectory-backtracking.md` — @fate baseline (five properties).
- `docs/insights/2026-05-26-kintsugi-as-credo-and-formatter-unified.md` — @kintsugi/fracture; FP collapse; the meta-bug --strict should have caught.
- `docs/insights/2026-05-26-scene-as-substrate-primitive-for-multi-actor-interaction.md` — @scene + scene-as-grammar deepening.
- `docs/insights/2026-05-26-epistemologic-reality-frame-scientific-grounding.md` — Frame Engineering scientific grounding (Minsky, Goffman, Bateson, Watzlawick, Snow-Benford).
- `docs/insights/2026-05-26-mirror-tensors-vs-industry-tensors-research.md` — partial-novelty verdict on the tensor framing.
- `docs/insights/2026-05-26-fixed-and-the-spectral-feedback-fracture.md` — `fixed` keyword + dynamic-beam-to-fixed fracture + kintsugi-as-mycelial-AI voice.
- `docs/insights/2026-05-26-mirror-sub-turing-substrate-with-emergent-turing-completeness.md` — the two-altitude resolution against Lachmann-Sella.
- `docs/insights/2026-05-26-ants-colonies-stigmergy-and-mirrors-tournament.md` — partial-hold verdict on ant-colony connections.
...
- `docs/specs/gap-tension-tensor-substrate.md` — the gap/tension/tensor substrate + convergence proof (1483 lines; formal math from Domingos / LTN / Topping / Bodnar / Hajek / FPTAS / Tarski).
- `docs/specs/spectral-db-three-tier-architecture.md` — the four-tier storage architecture (Nix cold + iceberg deep archive) + tombstones + biology-typed pheromone dynamics.
- `docs/specs/kintsugi-fracture-confidence-and-scene-dispatch.md` — confidence-dispatched fracture composition with @scene.
- `docs/specs/mirror-grammar-self-hosted.md` — the self-hosted tokenizer + spectral measurement spec (per #94).

## License documents

- `license/APACHE2.md` — Apache License 2.0 (compiler + protocols + open adapters).
- `license/SEL.md` — systemic.engineering License (v1.0 effective + v1.1 draft amendments).
- `~/dev/systemic.engineering/LICENSE-v1.1-draft.md` — the canonical SEL v1.1 draft (source for `license/SEL.md` Part II).
...
- Hart, P.E., Nilsson, N.J., Raphael, B. (1968). "A Formal Basis for the Heuristic Determination of Minimum Cost Paths." IEEE TSSC SSC-4(2):100–107.
- Hansen, J. & Ghrist, R. (2019). "Spectral theory of cellular sheaves." arXiv:1808.01513.
- Bodnar, C., Di Giovanni, F., et al. (2022). "Neural Sheaf Diffusion." arXiv:2202.04579.
- Topping, J. et al. (2022). "Understanding over-squashing and bottlenecks on graphs via curvature." arXiv:2111.14522.
- Serafini, L. & Garcez, A.d. (2020/2021). "Logic Tensor Networks." arXiv:2012.13635.
- Domingos, P. (2025). "Tensor Logic: The Language of AI." arXiv:2510.12269.
- Jolicoeur-Martineau, A. et al. (2025). "Less is More: Recursive Reasoning with Tiny Networks (TRM)." arXiv:2510.04871.
- Baek, J. et al. (2026). "Generative Recursive Reasoning Models (GRAM)." arXiv:2605.19376.
- Dorigo, M. & Blum, C. (2005). "Ant colony optimization theory: A survey." TCS 344:243–278.
- Klein, I., Mailly, J.G., Thimm, M. (2020). "Classifying Inconsistency Measures Using Graphs." JAIR 66.
